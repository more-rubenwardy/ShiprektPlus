...
string getRandomMap(CRules@ this)
{
	...
	if ( pCount <= 8 || true )
	{
		maps.push_back( "CenterIsles2.png" );
	 maps.push_back( "CenterIsles3.png" );	 maps.push_back( "CenterIsles4.png" );  maps.push_back( "CenterIsles5.png" );    maps.push_back( "SandBars.png" );    maps.push_back( "Clover.png" );      maps.push_back( "Channels.png" );          maps.push_back( "Tribute.png" );                  	}
