...
void onRender( CRules@ this )
{
	...
	if ( showHelp )
	{
		...
		//
		string intro =  "Welcome to Shiprekt Plus! Made by Strathos, Chrispin, and various other community members, this mod adds many improvements to the original Shiprekt.\n Last changes and fixes by Galdo";
		Vec2f introSize;
		...
		+ "- 2015-02-11 - By Chrispin\n"
		+ "   Added tools menu. Press R to access by default.\n"
		+ "   Added deconstructor tool for reclaiming/selling ship parts.\n"
		+ "   Freebuild requires 90% yes votes out of the total votes.\n"
		+ "   Added ram engines. Very fragile but very fast.\n"
		+ "   Buffed normal engines against flak.\n"
		+ "   Added new weapon: point defense turret. Shoots down projectiles but easy to overwhelm with machineguns.\n"
		+ "   Ship collisions reworked to only deal damage if using blocks meant for ramming.\n"
		+ "   Minor tweaks to weapons, especially missile launchers and flak. Turret type weapons now block each other.\n"
		+ "- 2015-01-31 - By Galdo\n"
		+ "   Tweaked cooldown between free building mode votes and threshold\n"
		+ "   Removed warm up period while free building mode is enabled\n"
		+ "   Restricted the amount of flak cannons in the game to 10 per team (to prevent lag and abuse)\n";
