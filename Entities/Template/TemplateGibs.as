...
void onGib(CSprite@ this)
{
	...
	{
		SetupCustomEmitEffect( effectname, "TemplateGibs.as", "EmitBlood", 10, 5, 45 );
	}
    ...
    for(int i = 0; i < 10; i++)
    {
	    ...
	    CParticle@ gib     = makeGibParticle( "template_gibs.png",
	    										pos,
	    										vel + veladd,
	    ...
	    if(gib !is null)
	    {
	    	...
	    	gib.AddDieFunction("TemplateGibs.as", "CreateWaterSplash");
	    }
	}
}
