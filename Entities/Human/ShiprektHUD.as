...
void DrawStationStatus( CBlob@ station, Vec2f tl, CControls@ controls )
{
    ...
    GUI::DrawIcon( "Blocks.png", 72, Vec2f(16,16), tl + Vec2f( -112, 4), 1.0f, station.getTeamNum() );
	...
	GUI::DrawText( teamStationCount + "/" + totalStationCount + " (+"+teamStationCount*2+")", tl + Vec2f(-80, 11), col );
