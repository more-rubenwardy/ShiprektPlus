...
namespace CMap
{
	...
	const SColor color_rock(255, 160, 160, 160);
	...
	enum Blocks {
		...
		sand_shore_convex_LU1 = 404,
		sand_shore_convex_LD1 = 408,
		sand_shore_convex_RD1 = 412,
		sand_shore_straight_R1 = 416,
		sand_shore_straight_U1 = 420,
		sand_shore_straight_L1 = 424,
		sand_shore_straight_D1 = 428,
		sand_shore_concave_RU1 = 432,
		sand_shore_concave_LU1 = 436,
		sand_shore_concave_LD1 = 440,
		sand_shore_concave_RD1 = 444,
		sand_shore_peninsula_R1 = 448,
		sand_shore_peninsula_U1 = 452,
		sand_shore_peninsula_L1 = 456,
		sand_shore_peninsula_D1 = 460,
		sand_shore_strip_H1 = 464,
		sand_shore_strip_V1 = 468,
		sand_shore_island1 = 472,
		sand_shore_cross1 = 476,
		sand_shore_bend_RU1 = 480,
		sand_shore_bend_LU1 = 484,
		sand_shore_bend_LD1 = 488,
		sand_shore_bend_RD1 = 492,
		sand_shore_T_R1 = 496,
		sand_shore_T_U1 = 500,
		sand_shore_T_L1 = 504,
		sand_shore_T_D1 = 508,
		sand_shore_choke_R1 = 512,
		sand_shore_choke_U1 = 516,
		sand_shore_choke_L1 = 520,
		sand_shore_choke_D1 = 524,
		sand_shore_split_RU1 = 528,
		sand_shore_split_LU1 = 532,
		sand_shore_split_LD1 = 536,
		sand_shore_split_RD1 = 540,
		sand_shore_panhandleL_R1 = 544,
		sand_shore_panhandleL_U1 = 548,
		sand_shore_panhandleL_L1 = 552,
		sand_shore_panhandleL_D1 = 556,
		sand_shore_panhandleR_R1 = 560,
		sand_shore_panhandleR_U1 = 564,
		sand_shore_panhandleR_L1 = 568,
		sand_shore_panhandleR_D1 = 572,
		sand_shore_diagonal_R1 = 576,
		sand_shore_diagonal_L1 = 580,
	...
	{	
		...
		{
			map.SetTile(offset, CMap::grass_inland + map_random.NextRanged(4) );
			map.AddTileFlag( offset, Tile::BACKGROUND );
			map.AddTileFlag( offset, Tile::LIGHT_PASSES );
		}	
